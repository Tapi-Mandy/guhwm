...
static const int user_bh =
    14; /* 2 is the default spacing around the bar's font */
static const int showbar = 0;  /* 0 means no bar (using polybar instead) */
static const int topbar = 1;   /* 0 means bottom bar */
static const int vertpad = 10; /* vertical padding of bar */

/* TOPBAR LENGTH CONFIGURATION:
...
/* key definitions */
/* Mod4Mask = Super/Windows Key. Mod1Mask = Alt Key. */
...
static const Key keys[] = {
    ...
    /* Updated to use roficmd */
    {MODKEY, XK_p, spawn, {.v = roficmd}},
    {MODKEY | ShiftMask, XK_Return, spawn, {.v = termcmd}},
    {MODKEY, XK_b, spawn, SHCMD("~/.config/polybar/toggle.sh")},
